...
class ProgressTracker:
    ...
    def __init__(self, operation: str, total_size: Optional[int] = None, 
...
class FSSpecAdapter:
    ...
    def get_file(self, remote_path: str, local_path: Union[str, Path], 
    ...
    def get_files(self, remote_pattern: str, local_dir: Union[str, Path],
    ...
    def find_files(self, pattern: str, base_path: str = "", 
                   recursive: bool = False) -> Generator[Tuple[str, Dict], None, None]:
        """
        ...
        if recursive:
            ...
            glob_pattern = os.path.join(search_path, pattern) if search_path else pattern
