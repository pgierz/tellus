...
def check():
    ...
    try:
        ...
        if feature_flags.is_enabled(FeatureFlag.USE_NEW_ARCHIVE_SERVICE):
            console.print("✅ New archive service: Enabled")
        else:
            console.print("⚠️  New archive service: Disabled (legacy mode)")
        ...
        bridge = ArchiveBridge(service_container.service_factory)
        console.print("✅ Archive bridge: Available")
